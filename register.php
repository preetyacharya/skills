<?php 
 ...
 include'conn.php';
  ...
  if (isset($_POST['submit'])) {
    ...
    $sql_u = "SELECT * FROM myproject WHERE username='$username'";
    $sql_e = "SELECT * FROM myproject WHERE email='$email'";
    ...
    if (mysqli_num_rows($res_u) > 0) {
      ...
      $email_error = "Sorry... email already taken";  
           ...
           $query = "INSERT INTO myproject (username, email, password,birthday,gender,country,education) 
                  VALUES ('$username', '$email', '".md5($password)."','$birthday' ,'$gender' ,'$country' ,'$education')";
...
<body>
    ...
    <center>
        <section id="register">
        <form  method="POST">
            <input type="hidden" name="action" value="registration" autocomplete="off">
              <table>
                ...
                <div class="upload-profile-image d-flex justify-content-center pb-5">
                    <div class="text-center">
                        <img src="pp.png" style="width: 150px; height: 150px" class="img rounded-circle" alt="profile">
                    </div>
                </div>
        ...
        <tr>
            <td>Education:</td>
            <td><input type="education" name="education">
            </td>
            <tr>
                <td>Country:</td>
